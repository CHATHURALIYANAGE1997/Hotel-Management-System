...
session_start();
// Include config file
require_once "../config/configmana.php"; 
...
<div class="demo-table">
	...
	<hr>
    <p><br>
        <a id="a" href="add/emp_add.php" class="btnLogin">Add New Employee</a><br><br>
		<a id="a" href="add/facility.php" class="btnLogin">Add New Facility</a><br><br>
